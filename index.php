...
<body>
    <div class = "top">
        ...
        <button style="position: absolute; right: 30px; top: 28px; border-radius:10px 10px 10px 10px" class="button01" type="button" onclick="alert('Hello world!')">Log In</button>
        <button style="position: absolute; right:120px; top: 28px; border-radius:10px 10px 10px 10px"  class="button01">Sign Up</button>
    </div>
            ...
            <div class="card-columns">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="demo1.php" class="button" style=" border-radius:10px 0 10px 0">View</a>
